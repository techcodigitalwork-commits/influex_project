...
const creatorPlans = [
  {
    ...
    tokens: 100,
    features: [
      { text: "Profile create karo", ok: true },
...
const brandPlans = [
  {
    ...
    tokens: 100,
    features: [
      { text: "10 campaign posts free", ok: true },
      { text: "100 tokens/month", ok: true },
...
const tokenUseCases = {
  creator: [
    { action: "Campaign apply karo", cost: "10 tokens" },
  ...
  brand: [
    { action: "Campaign post karo", cost: "10 tokens" },
    { action: "Influencer contact unlock", cost: "20 tokens" },
...
const escrowSteps = [
  { step: "1", icon: "📋", title: "Campaign Create", desc: "Brand campaign post karta hai aur budget set karta hai. Example: ₹10,000" },
  { step: "2", icon: "💰", title: "Escrow Deposit", desc: "Brand ₹10,000 platform pe deposit karta hai. Paisa secure lock ho jaata hai." },
  { step: "3", icon: "🤝", title: "Creator Accept", desc: "Creator campaign accept karta hai aur kaam shuru karta hai." },
  { step: "4", icon: "📸", title: "Work Submit", desc: "Creator deliverables submit karta hai: reel link, post proof, story screenshot." },
  { step: "5", icon: "✅", title: "Brand Approves", desc: "Brand kaam check karke approve karta hai." },
  { step: "6", icon: "🎉", title: "Payment Release", desc: "Platform payment release karta hai. Creator: ₹9,000 | Platform: ₹1,000 (10% commission)" },
];

const platformFeatures = [
  {
    icon: "🔒",
    title: "Contact Info Hide",
    desc: "Jab tak deal confirm nahi, creator ka phone, email, WhatsApp, Instagram — sab hidden. Sirf in-app chat.",
    tag: "Privacy",
    tagColor: "#4f46e5",
  },
  {
    ...
    desc: 'Agar chat mein "WhatsApp", "phone number", "DM me" type karo to platform warning deta hai. Communication sirf app ke andar.',
    tag: "Safety",
    tagColor: "#ef4444",
  },
  {
    ...
    desc: "Brand aur creator dono agreement sign karte hain — deliverables, timeline, payment — sab legally documented.",
    tag: "Legal",
    tagColor: "#16a34a",
  },
  {
    ...
    desc: "Campaign tab tak complete nahi hoga jab tak creator reel/post/story proof upload na kare aur brand approve na kare.",
    tag: "Tracking",
    tagColor: "#d97706",
  },
  {
    icon: "🏆",
    title: "Reward System",
    desc: "Platform pe deal complete karne par: extra tokens, profile boost, better ranking. Direct deal karna nuksaan hai.",
    tag: "Rewards",
    tagColor: "#7c3aed",
  },
  {
    ...
    desc: "Brand ke campaign ke hisaab se best creators suggest karta hai. Niche, followers, location — sab match karta hai.",
    tag: "AI",
    tagColor: "#0891b2",
  },
];
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* Hero */
        .up-hero{
          position:relative;padding:60px 40px 0;text-align:center;
          background:radial-gradient(ellipse 80% 50% at 50% -10%,rgba(79,70,229,0.35) 0%,transparent 70%);
        }
        ...
        .up-hero-title{font-size:clamp(28px,5vw,52px);font-weight:900;line-height:1.1;margin-bottom:16px;background:linear-gradient(135deg,#fff 30%,#a5b4fc 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
        ...
        /* Tabs */
        .up-tabs{display:flex;gap:0;border-bottom:1px solid rgba(255,255,255,0.08);padding:0 40px;overflow-x:auto;scrollbar-width:none;margin-bottom:0}
        ...
        .plan-card{border-radius:20px;padding:28px;position:relative;border:1.5px solid rgba(255,255,255,0.08);background:rgba(255,255,255,0.03);transition:all 0.3s;cursor:default}
        ...
        .plan-cta{width:100%;padding:13px;border-radius:12px;font-size:14px;font-weight:800;font-family:'Plus Jakarta Sans',sans-serif;border:none;cursor:pointer;transition:all 0.25s}
        .plan-cta.primary{background:linear-gradient(135deg,#4f46e5,#7c3aed);color:#fff;box-shadow:0 4px 20px rgba(79,70,229,0.4)}
        .plan-cta.primary:hover{transform:translateY(-2px);box-shadow:0 6px 28px rgba(79,70,229,0.55)}
        .plan-cta.secondary{background:rgba(255,255,255,0.06);color:rgba(255,255,255,0.4);cursor:default}
        .plan-cta.pro-plus{background:linear-gradient(135deg,#7c3aed,#ec4899);box-shadow:0 4px 20px rgba(124,58,237,0.4)}
        .plan-cta.pro-plus:hover{transform:translateY(-2px)}
        ...
        .token-uses-title{font-size:16px;font-weight:800;color:#fff;margin-bottom:16px;display:flex;align-items:center;gap:8px}
        ...
        .token-pack{border-radius:16px;padding:24px;border:1.5px solid rgba(255,255,255,0.08);background:rgba(255,255,255,0.03);cursor:pointer;transition:all 0.2s;position:relative;text-align:center}
      ...
      <div className="up">
        ...
        <div className="up-hero">
          ...
          <h1 className="up-hero-title">
            Platform pe deal karo,<br />secure rehna guaranteed hai
          </h1>
          <p className="up-hero-sub">
            Escrow payments, verified creators, smart contracts — sab kuch ek platform pe.
            Direct deal se zyada safe, zyada reliable.
          </p>
        ...
        <div className="up-content">
          ...
          {tab === "plans" && (
            <>
              ...
              <div className="section-sub">
                {role === "creator"
                  ? "Creators ke liye free se start karo, pro pe upgrade karo jab ready ho"
                  : "Brands ke liye best tools aur verified creators tak access"}
              </div>
              <div className="plans-grid">
                {plans.map((plan, i) => (
                  <div key={plan.name} className={`plan-card ${i === 1 ? "featured" : ""}`}>
                    {plan.badge && (
                    ...
                    <button
                      className={`plan-cta ${plan.ctaDisabled ? "secondary" : i === 2 ? "pro-plus" : "primary"}`}
                      disabled={plan.ctaDisabled}
                      onClick={() => !plan.ctaDisabled && router.push("/payment?plan=" + plan.name.toLowerCase())}
                    >
                      {plan.cta}
                    </button>
                  </div>
          ...
          {tab === "tokens" && (
            <>
              <div className="token-hero">
                ...
                <div className="token-hero-sub">Tokens se platform pe kaam karo. Apply karo, campaign post karo, contact unlock karo.</div>
              </div>

              <div className="token-cols">
                <div>
                  <div className="token-uses-title">
                    🎨 Creator — Token Uses
                  </div>
              ...
              <div className="token-packs-title">Extra Tokens Khareedon</div>
              <div className="token-packs">
                {tokenPacks.map((pack, i) => (
                  ...
                  >
                    ...
                    <div className="token-pack-bonus">
                      {pack.bonus > 0 ? `+${pack.bonus} bonus tokens!` : " "}
                    </div>
            ...
            <>
              <div className="escrow-hero">
                ...
                <div className="escrow-hero-sub">
                  Brand ka paisa secure hold hota hai. Creator kaam karo, brand approve karo, payment release hoti hai. 100% safe.
                </div>
              </div>
              ...
              <div className="escrow-breakdown">
                ...
                <div className="escrow-row">
                  ...
                  <span className="escrow-row-val brand">₹10,000</span>
                </div>
                <div className="escrow-row">
                  <span className="escrow-row-label">Platform commission (10%)</span>
                  <span className="escrow-row-val platform">₹1,000</span>
                </div>
                <div className="escrow-row">
                  <span className="escrow-row-label">Creator receives</span>
                  <span className="escrow-row-val creator">₹9,000</span>
                </div>
                <div className="escrow-row">
                ...
                <div className="escrow-badge">
                  🔒 Paisa tab release hota hai jab brand approve karta hai
                </div>
              </div>
            </>
          )}
          ...
          {tab === "features" && (
            <>
              ...
              <div className="section-sub">Ye sab features ensure karte hain ki deal platform pe hi ho</div>
        ...
        <div className="up-bottom">
          <div className="up-bottom-title">Platform pe deal karna<br />sabse smart choice hai</div>
          <div className="up-bottom-sub">
            Escrow protection • Verified creators • Smart contracts • Dispute resolution
          </div>
          <div className="up-bottom-btns">
            <button className="up-bottom-btn primary" onClick={() => setTab("plans")}>
              ✦ Plans Dekho
            </button>
            <button className="up-bottom-btn secondary" onClick={() => router.push("/browse")}>
              Creators Browse Karo →
            </button>
          </div>
        </div>
