                      ...
                      return (
                        <div className="np-creator-strip" onClick={() => viewCreatorProfile(n)}>
                          <div className="np-avatar">
                            {cImg ? <img src={cImg} alt="creator" /> : "👤"}
                          </div>
                          <div style={{ flex: 1 }}>
                            <div className="np-creator-name">{cName || "View Creator Profile"}</div>
                            <div className="np-creator-sub">
                              {cFollowers ? `👥 ${cFollowers} followers` : "Tap to see full profile"}
                            </div>
                          </div>
                          {profileLoading
