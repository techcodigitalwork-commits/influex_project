...
//       let restoredPlan = activePlan;
//       let restoredPlanActivatedAt = planActivatedAt;
//       let restoredBits: number | null = null;
//       if (isSubscribed && !activePlan) {
//         try {
//           const backup = localStorage.getItem("cb_plan_backup");
//           if (backup) {
...
//             if (b.activePlan) restoredPlan = b.activePlan;
//             if (b.planActivatedAt) restoredPlanActivatedAt = b.planActivatedAt;
//             if (b.bits != null) restoredBits = b.bits;
//           }
//         } catch { /* silent */ }
//       }
//       // Backup clear karo after use
...
//       // ✅ Plan ke hisaab se bits set karo login pe
//       const PLAN_TOKENS: Record<string, number> = {
//         free: 100, pro: 1000, pro_plus: 2000, pro_year: 0, pro_plus_year: 0
//       };
//       const planTokens = restoredPlan ? (PLAN_TOKENS[restoredPlan] ?? 100) : 100;
//       // ✅ backup se bits restore karo, nahi toh plan tokens se initialize
//       const storedBits = restoredBits ?? data.user.bits ?? planTokens;
//       const finalBits = isSubscribed && restoredPlan
//         ? (storedBits <= planTokens ? storedBits : planTokens)
//         : storedBits;
