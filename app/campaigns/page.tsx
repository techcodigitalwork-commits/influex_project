    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cm-field-hint { font-size: 11px; color: #bbb; margin-top: 5px; }
        ...
        <div className="cm-overlay">
          <div className="cm-box-edit">
            ...
            <div className="cm-field">
              ...
              <input value={editForm.categories} onChange={e => setEditForm({ ...editForm, categories: e.target.value })} placeholder="e.g. Fashion, Lifestyle, DJ" />
              <div className="cm-field-hint">💡 Multiple categories ko comma se alag karein</div>
            </div>
            <div className="cm-field">
              <label>Sub Categories (comma separated)</label>
              <input value={editForm.subCategories} onChange={e => setEditForm({ ...editForm, subCategories: e.target.value })} placeholder="e.g. Wedding Photographer, Fashion Model" />
              <div className="cm-field-hint">💡 Multiple sub categories ko comma se alag karein</div>
            </div>
