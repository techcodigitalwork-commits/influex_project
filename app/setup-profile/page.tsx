...
function PortfolioSection() {
  ...
  useEffect(() => {
    ...
    if (!currentUserId) { setError("User not found."); setLoading(false); return; }

    // ✅ Sirf apne userId se posts fetch karo
    fetch(`${API_BASE}/posts/${currentUserId}`, {
        ...
        <div style={{ maxWidth:680, margin:"0 auto", padding:"0 16px 60px" }}>
          ...
          <div className="vp-fade vp-header-row" style={{ marginTop:-56, marginBottom:20 }}>
            ...
            <div style={{ display:"flex", gap:10, flexWrap:"wrap", alignItems:"center" }}>
              ...
              {!isBrand && (
                <button className="vp-bank-btn vp-edit-desktop" onClick={() => router.push("/bank-details")}>
                  🏦 Bank Details
                </button>
              )}
            </div>
